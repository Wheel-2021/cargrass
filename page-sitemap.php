<?php get_header(); ?>
<?php
  $sitemap_subtitle = get_field_object('sitemap_subtitle');
;?>
      ...
      <section class="contents__base">
        <div class="contents__base--inner">
          <div class="contentsBase__wrap">
            <h2 class="subTtl"><?php echo $sitemap_subtitle["value"]; ?></h2>
            <p class="subTtl__small"><?php echo $sitemap_subtitle["label"]; ?></p>

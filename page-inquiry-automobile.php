<?php get_header(); ?>
<?php
  $automobile_inquiry_subtitle = get_field_object('automobile_inquiry_subtitle');
;?>
      ...
      <section class="contents__base">
        <div class="contents__base--inner">
          <div class="contentsBase__wrap">
            <h2 class="subTtl"><?php echo $automobile_inquiry_subtitle["value"]; ?></h2>
            <p class="subTtl__small"><?php echo $automobile_inquiry_subtitle["label"]; ?></p>

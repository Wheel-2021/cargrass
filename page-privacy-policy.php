<?php get_header(); ?>
<?php
  $privacypolicy_subtitle = get_field_object('privacypolicy_subtitle');
;?>
      ...
      <section class="contents__base">
        <div class="contents__base--inner">
          <div class="contentsBase__wrap">
            <h2 class="subTtl"><?php echo $privacypolicy_subtitle["value"]; ?></h2>
            <p class="subTtl__small"><?php echo $privacypolicy_subtitle["label"]; ?></p>
